 ...
 */
final class Version20220127234551 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE entretien (id INT AUTO_INCREMENT NOT NULL, candidat_id INT NOT NULL, travail_id INT NOT NULL, date DATE NOT NULL, lieu VARCHAR(255) NOT NULL, heure VARCHAR(8) NOT NULL, INDEX IDX_2B58D6DA8D0EB82 (candidat_id), INDEX IDX_2B58D6DAEEFE7EA9 (travail_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
